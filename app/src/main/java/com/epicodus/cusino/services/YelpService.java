...
public class YelpService {
    public static void findRestaurants(String foodType,String cityName, Callback callback) {
        ...
        urlBuilder.addQueryParameter(Constants.YELP_LOCATION_QUERY_PARAMETER, cityName);

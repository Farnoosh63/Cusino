package com.epicodus.foodfinder.services;
...
public class YelpService {
    public static void findRestaurants(String foodType, Callback callback) {
        ...
        urlBuilder.addQueryParameter(Constants.YELP_FOODTYPE_QUERY_PARAMETER, foodType);
        urlBuilder.addQueryParameter(Constants.YELP_LOCATION_QUERY_PARAMETER, "portland");
